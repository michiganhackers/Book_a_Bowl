...
After meticulously debugging the project and finally arriving at a suitable solution, you decide your code is suitable to be pushed to ~~main~~ dev. To do so, you should submit a pull request again on our [github](https://github.com/michiganhackers/Book_a_Bowl/pulls). In here, you will document your changes to the code and how you've tested them. Expect to receive heavy feedback, including any requested changes. More info on making a good pull request [here](#how-to-make-a-good-issuepull-request). Eventually, your pull request may be approved and your code committed to our codebase. Congratulations!
